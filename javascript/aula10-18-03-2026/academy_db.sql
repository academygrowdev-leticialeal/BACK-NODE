...
CREATE TABLE "pessoas" (
  "id" uuid UNIQUE PRIMARY KEY NOT NULL DEFAULT (generate_uid()),
...
ALTER TABLE "alunos" ADD FOREIGN KEY ("perfil_id") REFERENCES "pessoas" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "professores" ADD FOREIGN KEY ("perfil_id") REFERENCES "pessoas" ("id") DEFERRABLE INITIALLY IMMEDIATE;
